<?php
  ...
  $result = getArticleByArticleid($article_id);
?>
      ...
      <div class="edit-post">
        <form action="./handle_update.php" method="POST">
          ...
          <div class="edit-post__input-wrapper">
            <input class="edit-post__input" placeholder="請輸入文章標題" name="title" value="<?php echo $result['title']?>"/>
          </div>
          <div class="edit-post__input-wrapper">
            <textarea rows="20" class="edit-post__content" name="content" maxlength="300"><?php echo $result['content']?></textarea>
          </div>
